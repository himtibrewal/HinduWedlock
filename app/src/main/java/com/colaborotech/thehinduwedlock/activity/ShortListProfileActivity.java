...
public class ShortListProfileActivity extends BaseActivity implements View.OnClickListener, RecyclerAdapter.ReturnView, GetWebServiceData {
    ...
    private List<UserModel> shortlistList = new ArrayList<UserModel>();
    ...
    public void initialize() {
        ...
        recyclerAdapter = new RecyclerAdapter(shortlistList, this, R.layout.item_4_bottom_icon, this, 0);
    }
