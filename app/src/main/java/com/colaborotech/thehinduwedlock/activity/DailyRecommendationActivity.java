...
public class DailyRecommendationActivity extends BaseActivity implements View.OnClickListener, RecyclerAdapter.ReturnView, GetWebServiceData {
    ...
    private List<UserModel> dailyRecommList = new ArrayList<UserModel>();
    ...
    public void init(Bundle save) {
        ...
        recyclerAdapter = new RecyclerAdapter(dailyRecommList, this, R.layout.item_4_bottom_icon, this, 0);
    ...
    public void getWebServiceResponse(String responseData, int serviceCounter) {
        ...
        rlJustJoined.setAdapter(recyclerAdapter);
        tvHeader.setText("Daily Recommen..(" + dailyRecommList.size() + ")");
        recyclerAdapter.notifyDataSetChanged();
    }
