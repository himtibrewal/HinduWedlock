...
public class ProfileVisitorsActivity extends BaseActivity implements View.OnClickListener, GetWebServiceData, RecyclerAdapter.ReturnView {
    ...
    public void initialize() {
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                currentPage = 0;
                getProfileVisitors(AppPref.getInstance().getuserId(), currentPage);
            }
        });
        ...
        recyclerAdapter = new RecyclerAdapter(blockuserList, this, R.layout.item_4_bottom_icon, this, 0);
    }
