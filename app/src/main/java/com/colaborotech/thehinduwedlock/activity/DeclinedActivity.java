...
public class DeclinedActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initialize() {
        ...
        tvHeader.setText("Declined Members");
        tvTab1.setText("I Declined(0)");
        tvTab2.setText("They Declined(0)");
